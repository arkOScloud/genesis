Genesis.PackageController = Ember.ObjectController.extend();

Genesis.PackagesController = Ember.ObjectController.extend({
  sortBy: ['id'],
  installedQuery: '',
  availableQuery: '',
...
Genesis.PackageOpsController = Ember.ObjectController.extend({
  sortBy: ['id'],
  ...
  actions: {
    ...
    save: function() {
      ...
      var exec = $.ajax({
        url: Genesis.Config.krakenHost+'/system/packages',
